...
// app.use(cors({ origin: '*' }))
app.use(cors({
  origin: ['https://70bdfdf3.cloudexpress-player.pages.dev', 'https://04e01557.cloudexpress-frontend.pages.dev', 'http://127.0.0.1:5503'] // Replace with your allowed origins
}));
