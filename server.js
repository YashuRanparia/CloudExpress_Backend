...
// app.use(cors({ origin: '*' }))
app.use(cors({
  origin: ['http://127.0.0.1:5500','https://230ab316.cloudexpress-frontend.pages.dev', 'https://908fa98a.cloudexpress-player.pages.dev'] // Replace with your allowed origins
}));
